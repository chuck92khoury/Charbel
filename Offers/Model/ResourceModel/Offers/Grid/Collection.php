...
namespace Charbel\Offers\Model\ResourceModel\Offers\Grid;
...
class Collection extends AbstractCollection implements SearchResultInterface {
    ...
    protected function _initSelect() {
        ...
        $this->getSelect()
            ->joinLeft(
                ['category' => $this->getConnection()->getTableName('catalog_category_entity_varchar')],
                ['offers.category = category.id','category.attribute_id'],
                ['value']
            );
